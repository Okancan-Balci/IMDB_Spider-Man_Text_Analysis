...
review_data %>% 
  ...
  geom_smooth(color = "#9d1a28", size = 1.2)+
  geom_vline(xintercept = ymd("2021-12-15"), color = "#bf2431", size = 1.3)+
  geom_vline(xintercept = ymd("2018-02-18"), color = "#4d98e1", size = 1.3)+# Bully Maguire First Appearance 
...
review_data %>% 
  ...
  geom_point(alpha = 0.4, color = "#29329b")+
  geom_smooth(color = "#9d1a28", size = 1.2)+
  geom_vline(xintercept = ymd("2021-12-15"), color = "#bf2431", size = 1.3, alpha = 0.8)+
  geom_vline(xintercept = ymd("2018-02-18"), color = "#4d98e1", size = 1.3)+
  facet_wrap(~Movie, scales = "free")+
